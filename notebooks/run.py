...
feature_set = ["char", "word", "par", "rest"]
epochs = 1

X_train, y_train, X_validation, y_validation, X_test, y_test =  prepare_gittables()

model, X_test, y_test = train_sherlock(model_id, experiment_name, X_train, y_train, X_validation, y_validation, X_test, y_test, feature_set, epochs)