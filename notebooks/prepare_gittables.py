...
def split_data(data, targets, test_size=0.2, random_state=42, store_fp = None):
    ...
    tuple
        _description_
    """
    X_train, X_test, y_train, y_test = train_test_split(data, targets, test_size=test_size, random_state=random_state, stratify=targets)
    X_train, X_validation, y_train, y_validation = train_test_split(X_train, y_train, test_size=test_size, random_state=random_state, stratify=y_train)
